    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeSlider) {
                ...
                const inputClone0 = document.querySelector(".noUi-handle-lower");
                const inputClone1 = document.querySelector(".noUi-handle-upper");
                if (inputClone0) inputClone0.insertAdjacentHTML("afterbegin", `\n\t\t\t <label class="noUi-touch-area-cloning noUi-touch-area-cloning--left">\n\t\t\t  <span class="noUi-touch-area-span">$</span>\n\t\t\t  <input class="noUi-touch-area-clone0" type="number" min="0" max="1000">\n\t\t\t </label>\n\t\t\t`);
                if (inputClone1) inputClone1.insertAdjacentHTML("afterbegin", `\n\t\t\t <label class="noUi-touch-area-cloning noUi-touch-area-cloning--right">\n\t\t\t  <span class="noUi-touch-area-span">$</span>\n\t\t\t  <input class="noUi-touch-area-clone1" type="number" min="0" max="1000">\n\t\t\t </label>\n\t\t\t`);
                const numderSpan0 = document.querySelector(".noUi-touch-area-clone0");
                const numderSpan1 = document.querySelector(".noUi-touch-area-clone1");
                const numderSpans = [ numderSpan0, numderSpan1 ];
                rangeSlider.noUiSlider.on("update", (function(values, handle) {
                    inputs[handle].value = Math.round(values[handle]);
                }));
                rangeSlider.noUiSlider.on("update", (function(values, handle) {
                    numderSpans[handle].value = Math.round(values[handle]);
                }));
            }
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".footer-header__slider")) new swiper_core_Swiper(".footer-header__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".arrivals__slider")) new swiper_core_Swiper(".arrivals__slider", {
            ...
            if (document.querySelector(".trending__slider")) new swiper_core_Swiper(".trending__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".slide-sale-inside__slider")) new swiper_core_Swiper(".slide-sale-inside__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".slide-sale__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slide-sale-inside-button-prev",
                    nextEl: ".slide-sale-inside-button-next"
                },
                on: {}
            });
            if (document.querySelector(".aside-women__slider")) new swiper_core_Swiper(".aside-women__slider", {
                ...
                mousewheel: true,
                scrollbar: {
                    el: ".aside-women__swiper-scrollbar",
                    draggable: true
                },
                on: {}
            });
            if (document.querySelector(".women__slider")) new swiper_core_Swiper(".women__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                navigation: {
                    prevEl: ".women__button-prev",
                    nextEl: ".women__button-next"
                },
                on: {}
            });
            if (document.querySelector(".color-slider")) new swiper_core_Swiper(".color-slider", {
                modules: [ Navigation, Pagination, Scrollbar ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                mousewheel: true,
                scrollbar: {
                    el: ".color-slider__swiper-scrollbar",
                    draggable: true
                },
                on: {}
            });
            if (document.querySelector(".info__picters")) {
                let thumbsSwiper = new swiper_core_Swiper(".slider-info", {
                    modules: [ Navigation, Controller, Thumb, EffectFade ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 5,
                    spaceBetween: 20,
                ...
                new swiper_core_Swiper(".slider-picters", {
                    ...
                    navigation: {
                        prevEl: ".slider-picters__button.slider-picters__button--left",
                        nextEl: ".slider-picters__button.slider-picters__button--right"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".complete__slider")) new swiper_core_Swiper(".complete__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".interested__slider")) new swiper_core_Swiper(".interested__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".interested__button-prev",
                    nextEl: ".interested__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".recently__slider")) new swiper_core_Swiper(".recently__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".recently__button-prev",
                    nextEl: ".recently__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".picter-inf__slider")) new swiper_core_Swiper(".picter-inf__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slider-details__button--left",
                    nextEl: ".slider-details__button--right"
                },
                on: {}
            });
            if (document.querySelector(".all-reviews__slider")) new swiper_core_Swiper(".all-reviews__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".all-reviews__swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return '<span class ="' + className + '">' + (index + 1) + "</span>";
                    }
                ...
                navigation: {
                    prevEl: ".all-reviews__button--left",
                    nextEl: ".all-reviews__button--right"
                },
                on: {}
            });
            if (document.querySelector(".wishlist__slider")) new swiper_core_Swiper(".wishlist__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".wishlist__button-prev",
                    nextEl: ".wishlist__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".slide-sale-wishlist__slider")) new swiper_core_Swiper(".slide-sale-wishlist__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".slide-sale-wishlist-button-prev",
                    nextEl: ".slide-sale-wishlist-button-next"
                },
                on: {}
            });
            if (document.querySelector(".fashions__slider")) new swiper_core_Swiper(".fashions__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".fashions__swiper-pagination",
                    clickable: true,
                    renderBullet: function(index, className) {
                        return '<span class ="' + className + '">' + (index + 1) + "</span >";
                    }
                ...
                navigation: {
                    prevEl: ".fashions__swiper-button-prev",
                    nextEl: ".fashions__swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".header-post__slider")) new swiper_core_Swiper(".header-post__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".header-post__swiper-button-prev",
                    nextEl: ".header-post__swiper-button-next"
                },
                on: {}
            });
        }
